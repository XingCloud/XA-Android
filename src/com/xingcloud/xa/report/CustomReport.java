...
import com.xingcloud.xa.custom.ICustomAction;
...
//	}
	...
	public void reportCustomAction(CustomField custom_data) {
		...
		try {
			custom_data.getSignedParams().setTimestamp(XTimeStamp.getTimeStamp());
...
//			params.append("log=");
	...
	public void reportCustomAction() {
		...
		{
			if(this.param.getTimestamp() == null || this.param.getTimestamp().length() <=0)
			{
				this.param.setTimestamp(XTimeStamp.getTimeStamp());
			}
...
//			params.append("appid=");
//			
//			params.append(URLEncoder.encode(XA.instance().getGameId(),"UTF-8"));
//			
//			params.append("&");
			params.append("json=");
